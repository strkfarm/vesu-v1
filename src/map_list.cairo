...
mod map_list_component {
    ...
    impl MapListTrait<TContractState, +HasComponent<TContractState>> of Trait<TContractState> {
        ...
        /// Returns the next item in the list or 0 if the item is the last one
        fn next(self: @ComponentState<TContractState>, list_id: felt252, item: u64) -> u64 {
            self.lists.read((list_id, item))
        }

        /// Returns the item before `item` or 0 if the item is the first one
        ...
        /// Removes an item from the list. Reverts if the item is not found. Cost increases with the list size.
        ...
        /// Returns the first item or zero if no items
        ...
        /// Returns all items in the list. Cost increases with the list size.
