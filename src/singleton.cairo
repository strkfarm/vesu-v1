...
mod Singleton {
    ...
    impl SingletonImpl of super::ISingleton<ContractState> {
        ...
        fn liquidate_position(ref self: ContractState, params: LiquidatePositionParams) -> UpdatePositionResponse {
            ...
            let debt = Amount {
                amount_type: AmountType::Delta, denomination: AmountDenomination::Assets, value: I257Trait::new(debt, true),
            };
            ...
            if receive_as_shares {
                ...
                collateral_delta = Zero::zero();
                collateral_shares_delta = Zero::zero();
            }
