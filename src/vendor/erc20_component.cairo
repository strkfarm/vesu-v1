...
// OpenZeppelin Contracts for Cairo v0.8.1 (token/erc20/erc20.cairo)
...
mod ERC20Component {
    ...
    impl ERC20<TContractState, +HasComponent<TContractState>> of interface::IERC20<ComponentState<TContractState>> {
